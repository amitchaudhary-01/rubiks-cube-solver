...
export default function RegisterPage() {
  ...
  // Handler for Google Signup / Login flow
  const handleGoogleSignup = () => {
    // If using NextAuth, you would call: signIn('google', { callbackUrl: '/' })
    // Or redirect to your backend Google OAuth route: window.location.href = "http://localhost:5000/api/auth/google";
    console.log("Google signup clicked");
  };

  return (
    <main className="min-h-[calc(100vh-64px)] bg-gray-50 px-5 py-12">
        ...
        <div className="w-full rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Create your CubeSolver account to save your solves.
            </p>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-100"
            >
